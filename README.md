...
| l                  | location                                                 | 0: Sólinn, 1: Jörðinn, 2: Either, 3: Unknown | From what location in HR the trash was collected from |
...
| wt	                 | Weight	                                                | 0: Not specified or unmeasurable <br> Other number: The weight	                        | To provide information about the weight of the trash items |
...
| re	             | Recyclable or not	                                    | 0: Not recyclable <br> 1: Recyclable <br> 2: Unknown                                                                         | To indicate if the item is recyclable                  |
...
| co                 | Compostable                                              | 0: Uncertain <br> 1: Not compostable, 2: Compostable | Indicating if the item is compostable         |
